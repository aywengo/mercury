...
The command also appears in [`distribution.md`](../../distribution.md) — the release notes
offer an install only once the version is actually on the registry (§15), and it is now.
